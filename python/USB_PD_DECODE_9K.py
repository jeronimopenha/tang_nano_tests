...
class USB_PD_DECODE_9K:
	...
	def __init__(self, dev='/dev/ttyUSB0', baudrate=3000000, debug=False):
		self.dev           = dev
		self.baudrate      = baudrate
		self.debug         = debug
		self.uart          = pyftdi.serialext.serial_for_url('ftdi://ftdi:2232:1/2', baudrate=3000000, bytesize=8, parity='N', stopbits=1, timeout=1)
